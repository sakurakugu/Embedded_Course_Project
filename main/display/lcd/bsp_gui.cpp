 ...
 * @retvalue   :None
********************************************************************/
void GUI_DrawPoint(uint16_t x,uint16_t y,uint16_t color)//在屏幕上显示一个指定颜色的像素点
{
 ...
 * @retvalue   :None
********************************************************************/
void LCD_Fill(uint16_t sx,uint16_t sy,uint16_t ex,uint16_t ey,uint16_t color)//在LCD屏幕上填充矩形区域
{  	
	uint16_t i,j;			
 ...
 * @retvalue   :None
********************************************************************/
void LCD_DrawLine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2)//在LCD屏幕上绘制直线
{
	uint16_t t; 
 ...
 * @retvalue   :None
******************************************************************************/
void LCD_DrawRectangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2)//在LCD屏幕上绘制矩形边框
{
 ...
 * @retvalue   :None
******************************************************************************/  
void LCD_DrawFillRectangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2)//在LCD屏幕上填充矩形区域
{
 ...
 * @retvalue   :None
******************************************************************************/  
void _draw_circle_8(int xc, int yc, int x, int y, uint16_t c)//在LCD屏幕上画圆,(xc,yc)：圆心坐标,(x,y)：当前计算的圆周点相对坐标
{
 ...
 * @retvalue   :None
******************************************************************************/ 
void Draw_Triangel(uint16_t x0,uint16_t y0,uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2)//在LCD屏幕上绘制三角形
{
 ...
 * @retvalue   :None
******************************************************************************/ 
void Gui_Drawbmp16(uint16_t x,uint16_t y,uint16_t bmp_x,uint16_t bmp_y,const unsigned char *p) //显示bmp_x*bmp_y 图片
{
  uint64_t i; 
	unsigned char picH,picL; 
	LCD_SetWindows(x,y,x+bmp_x-1,y+bmp_y-1);//窗口设置
