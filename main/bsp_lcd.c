...
//画笔颜色,背景颜色
u16 POINT_COLOR = 0x00FF,BACK_COLOR = 0xFFFF;  
u16 DeviceCode;	 
...
void LCD_WriteReg(u8 LCD_Reg, u16 LCD_RegValue)//向LCD控制器写入寄存器地址和对应配置值
{	
	LCD_WR_REG(LCD_Reg);  
 ...
 * @retvalue   :None
******************************************************************************/	 
void LCD_WriteData_16Bit(u16 Data)//16位RGB565格式的颜色数据分解传输到LCD     16bit-->18bit
{	
 ...
 * @retvalue   :None
******************************************************************************/	
void LCD_DrawPoint(u16 x,u16 y)	//在指定坐标(x,y)处绘制一个预设颜色的像素点
{
 ...
 * @retvalue   :None
******************************************************************************/ 
void LCD_SetCursor(u16 Xpos, u16 Ypos)//设置1x1像素的显示窗口
{	  	    			
