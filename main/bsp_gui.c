 ...
 * @retvalue   :None
********************************************************************/
void GUI_DrawPoint(u16 x,u16 y,u16 color)//在屏幕上显示一个指定颜色的像素点
{
 ...
 * @retvalue   :None
********************************************************************/
void LCD_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 color)//在LCD屏幕上填充矩形区域
{  	
	u16 i,j;			
 ...
 * @retvalue   :None
********************************************************************/
void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2)//在LCD屏幕上绘制直线
{
	u16 t; 
 ...
 * @retvalue   :None
******************************************************************************/
void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2)//在LCD屏幕上绘制矩形边框
{
 ...
 * @retvalue   :None
******************************************************************************/  
void LCD_DrawFillRectangle(u16 x1, u16 y1, u16 x2, u16 y2)//在LCD屏幕上填充矩形区域
{
 ...
 * @retvalue   :None
******************************************************************************/  
void _draw_circle_8(int xc, int yc, int x, int y, u16 c)//在LCD屏幕上画圆,(xc,yc)：圆心坐标,(x,y)：当前计算的圆周点相对坐标
{
 ...
 * @retvalue   :None
******************************************************************************/ 
void Draw_Triangel(u16 x0,u16 y0,u16 x1,u16 y1,u16 x2,u16 y2)//在LCD屏幕上绘制三角形
{
 ...
 * @retvalue   :None
******************************************************************************/ 
void Gui_Drawbmp16(u16 x,u16 y,uint16_t bmp_x,uint16_t bmp_y,const unsigned char *p) //显示bmp_x*bmp_y 图片
{
  uint64_t i; 
